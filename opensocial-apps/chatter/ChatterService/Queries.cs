...
namespace ChatterService
{
    class Queries
    {
        public static readonly string SOQL_GET_RESEACH_PROFILE = @"
        ...
        public static readonly string SOQL_GET_ALL_USER_ACTIVITIES = @"
            Select u.Type,  u.ParentId, u.Id, u.CreatedDate, u.CreatedById, Body,
        ...
        public static readonly string SOQL_GET_USER_ACTIVITIES = @"
